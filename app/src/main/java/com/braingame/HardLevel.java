...
public class HardLevel extends AppCompatActivity {
    ...
    Button btn_ready, btn_answer0, btn_answer1,btn_answer2, btn_answer3, btn_answer4, btn_answer5, btn_answer6, btn_answer7, btn_answer8, btn_play_again;
    ...
    public void generateQuestions(){
        ...
        locationofcorrectanswer = random.nextInt(9);
        ...
        btn_answer6.setText(Integer.toString(answers.get(6)));
        btn_answer7.setText(Integer.toString(answers.get(7)));
        btn_answer8.setText(Integer.toString(answers.get(8)));
    }
